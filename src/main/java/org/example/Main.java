...
public class Main {
    public static void main(String[] args) {
        LinkedList<Employee> employeeList = getEmployees();
    ...
    private static LinkedList<Employee> getEmployees() {
        LinkedList<Employee> employeeList = new LinkedList<>();
        Employee employee1 = new Employee(1,"Alperen","Mimarlar");
        Employee employee2 = new Employee(1,"Alperen","Mimarlar");
        Employee employee3 = new Employee(3,"Özge", "sdasda");
        Employee employee4 = new Employee(4, "Alper","asdsada");
